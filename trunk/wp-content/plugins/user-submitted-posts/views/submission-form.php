...
<div id="user-submitted-posts">
	...
	<form id="usp_form" method="post" data-validate="parsley" enctype="multipart/form-data" action="" novalidate>
		...
		<!-- #comentario para testar a diminuição do Box para content
		...
		<?php if ($usp_options['usp_richtext_editor'] == true) { ?>
			...
			-->
				...
				<input name="user-submitted-content" type="text" value="" data-required="true" placeholder="<?php _e('Post Content', 'usp'); ?>" class="usp-textarea"></textarea>
		<?php } ?>
		</fieldset>
